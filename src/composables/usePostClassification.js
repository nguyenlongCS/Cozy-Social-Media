/*
src/composables/usePostClassification.js - Centralized Classification
Automatic post classification với centralized keyword dictionary
FIXED: Loại bỏ duplicate KEYWORD_DICTIONARY, centralize tại một nơi
Logic: Single source of truth cho classification algorithm và keywords
*/
import { ref } from 'vue'
...
export function usePostClassification() {
  ...
  // =============================================================================
  // CONSTANTS - CATEGORIES (19 danh mục chuẩn)
  // =============================================================================
  ...
  // =============================================================================
  // CENTRALIZED KEYWORD DICTIONARY (Single source of truth)
  // =============================================================================
  ...
  // =============================================================================
  // SCORING WEIGHTS (Hệ thống tính điểm)
  // =============================================================================
  ...
  /**
   * Tìm keywords matches trong text với scoring
   */
  function findKeywordMatches(text, keywords) {
    ...
    keywords.forEach(keyword => {
      ...
      // Partial match cho keywords có nhiều từ
  ...
  /**
   * Phân loại post caption thành các categories
   */
  function classifyPost(caption) {
    ...
    try {
      ...
      // Sort theo confidence và return tags
  ...
  const getCategoryKeywords = (category) => KEYWORD_DICTIONARY[category] || null
  
  const getKeywordDictionary = () => KEYWORD_DICTIONARY
  
  const getScoringWeights = () => SCORING_WEIGHTS
