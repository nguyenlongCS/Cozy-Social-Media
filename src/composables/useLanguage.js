/*
Composable quản lý ngôn ngữ - Refactored
Centralize logic chuyển đổi ngôn ngữ và provide text translations
- Loại bỏ syncWithProp logic phức tạp, sử dụng setLanguage trực tiếp
- Đơn giản hóa logic load/save localStorage
- Gộp chung tất cả text translations vào một object
*/
...
// Text translations - gộp chung tất cả text
const translations = {
  vi: {
    // Authentication
    login: 'Đăng nhập',
